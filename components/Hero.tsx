      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center md:text-left">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative mt-12 md:mt-0 block transform md:transform-none scale-100 origin-top">
            ...
            <div className="relative bg-slate-900 border border-slate-700 rounded-2xl p-4 md:p-6 shadow-2xl overflow-hidden pb-24 md:pb-28">
                {/* Dashboard Header */}
                <div className="flex justify-between items-center mb-6 border-b border-slate-800 pb-4">
                    ...
                    <div className="text-slate-400 text-xs font-mono">carga360_software.exe</div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-3 md:gap-4">
                    ...
                    <div className="col-span-2 space-y-3">
                        ...
                        <div className="bg-slate-800/50 p-2 md:p-3 rounded-lg flex flex-col sm:flex-row sm:items-center justify-between border border-slate-700/50 gap-2 sm:gap-0">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <div className="text-white text-sm font-semibold">TQX982</div>
                        ...
                        <div className="bg-slate-800/50 p-2 md:p-3 rounded-lg flex flex-col sm:flex-row sm:items-center justify-between border border-slate-700/50 gap-2 sm:gap-0">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <div className="text-white text-sm font-semibold">SNR441</div>
                                    <div className="text-slate-500 text-[10px] flex items-center gap-1">
                        ...
                        <div className="bg-slate-800/50 p-2 md:p-3 rounded-lg flex flex-col sm:flex-row sm:items-center justify-between border border-slate-700/50 opacity-75 gap-2 sm:gap-0">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <div className="text-slate-300 text-sm font-semibold">KNP102</div>
                    ...
                    <div className="col-span-1 space-y-4">
                        ...
                        {/* Drivers Card */}
                        <div className="bg-slate-800/50 p-3 rounded-lg border border-slate-700/50 flex-1">
                            <h4 className="text-slate-400 text-xs font-bold uppercase tracking-wider mb-2 flex flex-col xl:flex-row items-start xl:items-center gap-1">
                                <span className="flex items-center gap-2"><Users className="h-3 w-3" /> Conductores</span>
                            </h4>
                            <div className="flex -space-x-2 overflow-hidden mb-2">
                                <div className="inline-block h-8 w-8 rounded-full ring-2 ring-slate-900 bg-slate-600 flex items-center justify-center text-xs text-white">JD</div>
                                <div className="inline-block h-8 w-8 rounded-full ring-2 ring-slate-900 bg-slate-600 flex items-center justify-center text-xs text-white">AM</div>
                                <div className="inline-block h-8 w-8 rounded-full ring-2 ring-slate-900 bg-slate-600 flex items-center justify-center text-xs text-white">CR</div>
                            </div>
                            <div className="text-xs text-green-400 font-medium">+2 Disp.</div>
                        </div>

                        {/* Docs Card */}
                        <div className="bg-slate-800/50 p-3 rounded-lg border border-slate-700/50 relative overflow-hidden flex-1">
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center gap-1 text-[10px] text-slate-300 bg-red-500/10 p-1 rounded border border-red-500/20 w-full">
                                    <AlertCircle className="h-3 w-3 text-red-500 shrink-0" />
                                    <span className="truncate">SOAT SNR441</span>
                                </div>
                                <div className="flex items-center gap-1 text-[10px] text-slate-300 bg-slate-700/30 p-1 rounded w-full">
                                    <CheckCircle2 className="h-3 w-3 text-green-500 shrink-0" />
                                    <span className="truncate">RTM TQX982</span>
                                </div>
                            </div>
                        </div>
                ...
                {/* Floating Notification - Now Centered and in the safe padding zone */}
                <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 w-full max-w-[90%] md:max-w-xs flex justify-center">
                    <div className="bg-white text-slate-900 p-2 md:p-3 rounded-lg shadow-xl flex items-center gap-3 animate-bounce shadow-accent-500/20 border-l-4 border-accent-500 w-full">
                        <div className="bg-green-100 p-1.5 rounded-full shrink-0">
                            <CheckCircle2 className="h-4 w-4 text-green-600" />
                        </div>
                        <div className="flex-1 min-w-0">
                            <div className="flex justify-between items-baseline">
                                <p className="text-[10px] text-slate-500 uppercase font-bold">Orden #4092</p>
                                <span className="text-[9px] text-slate-400">Hace 1m</span>
                            </div>
                            <p className="text-xs font-bold truncate">Entregada en Cali</p>
                        </div>
                    </div>
                </div>
